...
export default function PrivacyPage() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12 text-gray-800">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-2">2. 제3자 API 사용</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-2">3. 로그 및 분석</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-2">4. 아동 개인정보 보호</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm mt-2 font-medium">journey.eo@gmail.com</p>
      </section>
    </main>
  );
}
