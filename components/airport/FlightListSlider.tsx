...
const FLIGHT_MINUTES: Record<string, number> = {
  NRT:130, HND:130, KIX:135, FUK:115, CTS:145, OKA:175, NGO:130, SDJ:155, KOJ:160, OIT:140, AOJ:100, ISG:150, YGJ:90,
  PEK:200, PKX:200, TSN:130, PVG:185, SHA:185, TAO:110, DLC:90, SHE:90, CGO:130, WUH:140, CSX:155,
  ...
  HNL:520, SYD:665, MEL:695, BNE:665, AKL:770,
};
...
function DurationBadge({ code }: { code?: string }) {
  ...
  if (!h || h < 7) return null;
  return (
    <span className="text-xs font-medium px-1.5 py-0.5 rounded leading-none bg-rose-50 text-rose-500">
      장거리
    </span>
  );
}
