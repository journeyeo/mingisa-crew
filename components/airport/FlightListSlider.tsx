...
const FLIGHT_MINUTES: Record<string, number> = {
  NRT:130, HND:130, KIX:135, FUK:115, CTS:145, OKA:175, NGO:130, SDJ:155, KOJ:160, OIT:140, AOJ:100, ISG:150, YGJ:90, TAK:90, KKJ:90, UKB:90, KMI:100, KMJ:90, KIJ:95, KMQ:95,
  PEK:200, PKX:200, TSN:130, PVG:185, SHA:185, TAO:110, DLC:90, SHE:90, CGO:130, WUH:140, CSX:155, HFE:120,
  HGH:160, NKG:150, TNA:115, TYN:145, HET:185, HRB:150, SJW:130, FOC:150, YNJ:90, CGQ:120,
                  ...
                  <div className={`flex items-start px-4 py-3 gap-3 ${flight.isDelayed ? "bg-orange-50/60" : isNoTransport ? "bg-orange-50/30" : ""}`}>
                    <div className="w-20 shrink-0 flex flex-col items-start gap-0.5 pt-0.5">
                      <div className="flex items-center gap-1">
                        <span className="text-[15px] font-mono font-bold text-gray-900 leading-tight">{primaryId}</span>
                    ...
                    <div className="flex-1 flex items-center min-w-0 gap-1.5 pt-0.5">
                      ...
                      <span className="text-[15px] font-semibold text-gray-900 truncate min-w-0">{flight.origin}</span>
                    </div>
                      ...
                      {flight.isDelayed ? (() => {
                        ...
                        return (
                          <>
                            ...
                            <p className="text-[15px] tabular-nums font-bold whitespace-nowrap flex items-center justify-end gap-1">
                        ...
                        <p className="text-[15px] text-gray-900 font-medium whitespace-nowrap flex items-center justify-end gap-0.5">
                          {isNextDay && <NextDayBadge />}
                          {isNoTransport && <span className="text-[10px] font-bold text-orange-600 bg-orange-50 border border-orange-200 px-1 rounded leading-[1.4]">심야</span>}
                          <TimeCell date={flight.landingTime} todayStr={todayStr} prefix="착륙" hideNextDay />
                        </p>
                      )}
                      <p className="text-[15px] font-semibold whitespace-nowrap text-gray-900">
